...
extern "C" {
  ...
  void set_point3D_obj(HybridPredictionContainer* container,
                      float** point3D_obj,
                      int nk) {
    ...
    for (int i = 0; i < nk; i++) {
      for (int j = 0; j < 3; j++) {
        (*keypoints)[i].point3D_obj[j] = point3D_obj[i][j];
      }
    }
  }

  void get_point3D_obj(HybridPredictionContainer* container,
                      float** point3D_obj,
                      int nk) {
    vector<Keypoint>* keypoints = container->GetKeypoints();
    for (int i = 0; i < nk; i++) {
      for (int j = 0; j < 3; j++) {
        point3D_obj[i][j] = (*keypoints)[i].point3D_obj[j];
      }
    }
  }
  
  void set_point3D_cam(HybridPredictionContainer* container,
                        float** point3D_cam,
                        int nk) {
    vector<Keypoint>* keypoints = container->GetKeypoints();
    keypoints->resize(nk);
    for (int i = 0; i < nk; i++) {
      for (int j = 0; j < 3; j++) {
        (*keypoints)[i].point3D_cam[j] = point3D_cam[i][j];
      }
    }
  }

  void get_point3D_cam(HybridPredictionContainer* container,
                        float** point3D_cam,
                        int nk) {
    vector<Keypoint>* keypoints = container->GetKeypoints();
    for (int i = 0; i < nk; i++) {
      for (int j = 0; j < 2; j++) {
        point3D_cam[i][j] = (*keypoints)[i].point3D_cam[j];
      }
    }
  }
  ...
  void set_point_inv_half_var(HybridPredictionContainer* container,
    ...
    for (int i = 0; i < nk; i++) {
      for (int j = 0; j < 3; j++) {
        for (int k = 0; k < 3; k++) {
          (*keypoints)[i].inv_half_var(j, k) = inv_half_var[i][j * 3 + k];
        }
      }
    }
  }
  ...
  void get_point_inv_half_var(HybridPredictionContainer* container,
    ...
    for (int i = 0; i < nk; i++) {
      for (int j = 0; j < 3; j++) {
        for (int k = 0; k < 3; k++) {
          inv_half_var[i][j * 3 + k] = (*keypoints)[i].inv_half_var(j, k);
        }
      }
    }
  }
  ...
  void set_vec_pred(HybridPredictionContainer* container,
    ...
    for (int i = 0; i < ne; i++) {
      ...
      (*edges)[i].vec_pred[2] = vec_pred[i][2];
    }
  }
  ...
  void get_vec_pred(HybridPredictionContainer* container,
    ...
    for (int i = 0; i < ne; i++) {
      ...
      vec_pred[i][2] = (*edges)[i].vec_pred[2];
    }
  }
  ...
  void set_edge_inv_half_var(HybridPredictionContainer* container,
    ...
    for (int i = 0; i < ne; i++) {
      for (int j = 0; j < 3; j++) {
        for (int k = 0; k < 3; k++) {
          (*edges)[i].inv_half_var(j, k) = inv_half_var[i][j * 3 + k];
        }
      }
    }
  }
  ...
  void get_edge_inv_half_var(HybridPredictionContainer* container,
    ...
    for (int i = 0; i < ne; i++) {
      for (int j = 0; j < 3; j++) {
        for (int k = 0; k < 3; k++) {
          inv_half_var[i][j * 3 + k] = (*edges)[i].inv_half_var(j, k);
        }
      }
    }
  }
  ...
  HybridPredictionContainer* initialize_pose_ablation(HybridPredictionContainer* predictions,
                                                      PRInitPara* pi_para,
                                                      int turn_on_kpt,
                                                      int turn_on_edge,
                                                      int turn_on_sym) {
  ...
  HybridPredictionContainer* refine_pose_ablation(HybridPredictionContainer* predictions,
...
//    }
  ...
  void delete_container1(vector<HybridPredictionContainer>* c1,
                         vector<AffineXform3d>* c2) {
    delete c1;
    delete c2;
  }

  void delete_container2(PRInitPara* c1,
                         PRRefinePara* c2) {
    delete c1;
    delete c2;
  }

  void delete_container3(HybridPredictionContainer* container) {
    delete container;
  }
}
