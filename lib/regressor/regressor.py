...
def load_wrapper():
    regressor = CDLL('/home/ubuntu/Code/Pose_Estimation/mypose/ffb6d/lib/regressor/wrapper.so')
    ...
    # set_point3D_gt()
    regressor.set_point3D_obj.argtypes = [c_void_p, c_2darr_p, c_int]
    # get_point3D_gt()
    regressor.get_point3D_obj.argtypes = [c_void_p, c_2darr_p, c_int]
    # set_point2D_pred()
    regressor.set_point3D_cam.argtypes = [c_void_p, c_2darr_p, c_int]
    # get_point2D_pred()
    regressor.get_point3D_cam.argtypes = [c_void_p, c_2darr_p, c_int]
    ...
    # initialize_pose()
    regressor.initialize_pose_ablation.argtypes = [c_void_p, c_void_p, c_int, c_int, c_int]
    regressor.initialize_pose_ablation.restype = c_void_p
    # refine_pose()
    regressor.refine_pose_ablation.argtypes = [c_void_p, c_void_p, c_int, c_int, c_int]
    regressor.refine_pose_ablation.restype = c_void_p
    ...
    # delete_container1()
    regressor.delete_container1.argtypes = [c_void_p, c_void_p]
    # delete_container2()
    regressor.delete_container2.argtypes = [c_void_p, c_void_p]
    # delete_container3()
    regressor.delete_container3.argtypes = [c_void_p]
